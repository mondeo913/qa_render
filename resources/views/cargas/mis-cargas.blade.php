...
<div class="mis-cargas-page">
    <section class="card siget-card">
        ...
        <div class="siget-file-section">
            <div class="alert alert-info mb-4"><i class="bi bi-info-circle me-1"></i>Este repositorio es exclusivo del usuario operativo. Las evidencias se clasifican por dependencia, mes, pauta y dirección. Al cerrar y enviar una evidencia, queda disponible para el Repositorio de Revisión institucional y para el repositorio de su dirección, sin duplicar físicamente el archivo.</div>
            ...
            @forelse($loads->groupBy(function ($load) { return optional($load->agency)->id ?: 'sin-dependencia'; }) as $agencyLoads)
                ...
                <section class="card border mb-4 dependency-card">
                    ...
                    <div class="card-body p-3 p-lg-4"><div class="loads-grid">
