    ...
    public static function for(string $roleCode): array
    {
        return match ($roleCode) {
            'ADMINISTRADOR' => [
                ...
                ['label' => 'Plantillas de evidencias', 'route' => 'admin.templates', 'icon' => 'bi-file-earmark-text'],
                ['label' => 'Plantillas de reportes', 'route' => 'reports.templates', 'icon' => 'bi-file-earmark-bar-graph'],
